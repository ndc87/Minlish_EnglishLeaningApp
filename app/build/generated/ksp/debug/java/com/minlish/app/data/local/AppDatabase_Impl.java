  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(7) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `cards` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `word` TEXT NOT NULL, `pos` TEXT NOT NULL, `meaning` TEXT NOT NULL, `example` TEXT NOT NULL, `pronunciation` TEXT, `descriptionEn` TEXT, `collocation` TEXT, `relatedWords` TEXT, `note` TEXT, `audioUrl` TEXT, `imageUrl` TEXT, `level` INTEGER NOT NULL, `topic` TEXT NOT NULL, `topicUrl` TEXT)");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'cc6c92044e4764aaca46f816ae87cb01')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsCards.put("pronunciation", new TableInfo.Column("pronunciation", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCards.put("descriptionEn", new TableInfo.Column("descriptionEn", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCards.put("collocation", new TableInfo.Column("collocation", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCards.put("relatedWords", new TableInfo.Column("relatedWords", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCards.put("note", new TableInfo.Column("note", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsCards.put("topic", new TableInfo.Column("topic", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCards.put("topicUrl", new TableInfo.Column("topicUrl", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "cc6c92044e4764aaca46f816ae87cb01", "9eb8fec523b2dd377ef233c1bbeff112");
