...
public final class DaggerMinLishApp_HiltComponents_SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new DashboardViewModel(singletonCImpl.userStatsDao(), singletonCImpl.learningLogDao());
  ...
  private static final class SingletonCImpl extends MinLishApp_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideCalculateSM2IntervalUseCaseProvider = DoubleCheck.provider(new SwitchingProvider<CalculateSM2IntervalUseCase>(singletonCImpl, 12));
      this.databaseSeederProvider = DoubleCheck.provider(new SwitchingProvider<DatabaseSeeder>(singletonCImpl, 13));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 9: // com.minlish.app.data.repository.AuthRepositoryImpl 
          ...
          case 12: // com.minlish.app.domain.usecase.CalculateSM2IntervalUseCase 
          return (T) UseCaseModule_ProvideCalculateSM2IntervalUseCaseFactory.provideCalculateSM2IntervalUseCase();

          case 13: // com.minlish.app.data.local.DatabaseSeeder 
          return (T) new DatabaseSeeder(singletonCImpl.cardDao(), singletonCImpl.reviewDao(), singletonCImpl.encryptedAuthStorageProvider.get());
